...
public class TemperatureActivity extends View {
    ...
    public static final float MAX_TEMP = 50, MIN_TEMP = -5;
    ...
    private static final float MAX_TEMP_F = 120, MIN_TEMP_F=-5;
    ...
    public TemperatureActivity (Context context, AttributeSet attrs){
        super(context, attrs);
        init(context, attrs);
    }
    public TemperatureActivity (Context context, AttributeSet attrs, int defStyleAttr){
    ...
    protected  void onDraw (Canvas canvas){
        ...
        float innerEffectEndtY= circleCenterY-outerCircleRadius-10;
        float innerRectHeight = innerEffectEndtY-innerEffectStartY;
        ...
        while(tmp <= innerEffectEndtY){
            ...
            tmp += (innerEffectEndtY-innerEffectStartY)/ nbGraduations;
            startGraduation -= inc;
        }
    }
}